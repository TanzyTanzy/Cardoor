...
conn = mysql.connector.connect(host='localhost',user='root',database='cardoor',buffered=True)
#conn = MySQLdb.connect(host='localhost',user='root',password='tanzytia',database='cardoor')
cur = conn.cursor()
